...
class TestSeries(unittest.TestCase):
    ...
    def test_next_game(self):
        ...
        self.assertTrue('Game 0' in str1)
        self.assertTrue(str(s.games[0]) in str1)
        ...
        self.assertTrue('Game 0' in str2)
        self.assertTrue(str(s.games[0]) in str2)
        ...
        self.assertTrue('Game 0' in str3)
        self.assertTrue('Game 1' in str3)
        self.assertTrue(str(s.games[0]) in str3)
        self.assertTrue(str(s.games[1]) in str3)
        ...
        self.assertTrue('Game 0' in str4)
        self.assertTrue('Game 1' in str4)
        self.assertTrue('Game 2' in str4)
        self.assertTrue(str(s.games[0]) in str4)
        self.assertTrue(str(s.games[1]) in str4)
        self.assertTrue(str(s.games[2]) in str4)
        ...
        self.assertTrue('Game 0' in str5)
        self.assertTrue('Game 1' in str5)
        self.assertTrue('Game 2' in str5)
        self.assertTrue('Game 3' in str5)
        self.assertTrue(str(s.games[0]) in str5)
        self.assertTrue(str(s.games[1]) in str5)
        self.assertTrue(str(s.games[2]) in str5)
        self.assertTrue(str(s.games[3]) in str5)
        ...
        self.assertTrue('Game 0' in str6)
        self.assertTrue('Game 1' in str6)
        self.assertTrue('Game 2' in str6)
        self.assertTrue('Game 3' in str6)
        self.assertTrue('Game 4' in str6)
        self.assertTrue(str(s.games[0]) in str6)
        self.assertTrue(str(s.games[1]) in str6)
        self.assertTrue(str(s.games[2]) in str6)
        self.assertTrue(str(s.games[3]) in str6)
        self.assertTrue(str(s.games[4]) in str6)
        ...
        self.assertTrue('Game 0' in str7)
        self.assertTrue('Game 1' in str7)
        self.assertTrue('Game 2' in str7)
        self.assertTrue('Game 3' in str7)
        self.assertTrue('Game 4' in str7)
        self.assertTrue('Game 5' in str7)
        self.assertTrue(str(s.games[0]) in str7)
        self.assertTrue(str(s.games[1]) in str7)
        self.assertTrue(str(s.games[2]) in str7)
        self.assertTrue(str(s.games[3]) in str7)
        self.assertTrue(str(s.games[4]) in str7)
        self.assertTrue(str(s.games[5]) in str7)
        ...
        self.assertTrue('Game 0' in str8)
        self.assertTrue('Game 1' in str8)
        self.assertTrue('Game 2' in str8)
        self.assertTrue('Game 3' in str8)
        self.assertTrue('Game 4' in str8)
        self.assertTrue('Game 5' in str8)
        self.assertTrue(str(s.games[0]) in str8)
        self.assertTrue(str(s.games[1]) in str8)
        self.assertTrue(str(s.games[2]) in str8)
        self.assertTrue(str(s.games[3]) in str8)
        self.assertTrue(str(s.games[4]) in str8)
        self.assertTrue(str(s.games[5]) in str8)
